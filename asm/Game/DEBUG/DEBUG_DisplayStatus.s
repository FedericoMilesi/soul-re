...
/* 4A74 80014274 0D80043C */  lui        $a0, %hi(D_800D01A8)
/* 4A78 80014278 A8018424 */  addiu      $a0, $a0, %lo(D_800D01A8)
/* 4A7C 8001427C C3B5000C */  jal        FONT_Print
/* 4A80 80014280 0100A524 */   addiu     $a1, $a1, 0x1
/* 4A84 80014284 0D80043C */  lui        $a0, %hi(D_800D01B8)
/* 4A88 80014288 5C02258E */  lw         $a1, 0x25C($s1)
/* 4A8C 8001428C C3B5000C */  jal        FONT_Print
/* 4A90 80014290 B8018424 */   addiu     $a0, $a0, %lo(D_800D01B8)
/* 4A94 80014294 3400228E */  lw         $v0, 0x34($s1)
/* 4A98 80014298 0D80043C */  lui        $a0, %hi(D_800D01C4)
/* 4A9C 8001429C 0000458C */  lw         $a1, 0x0($v0)
/* 4AA0 800142A0 B1500008 */  j          .L800142C4
/* 4AA4 800142A4 C4018424 */   addiu     $a0, $a0, %lo(D_800D01C4)
.L800142A8:
...
/* 4ABC 800142BC 0D80043C */  lui        $a0, %hi(D_800D01CC)
/* 4AC0 800142C0 CC018424 */  addiu      $a0, $a0, %lo(D_800D01CC)
.L800142C4:
...
/* 4AD0 800142D0 0D80043C */  lui        $a0, %hi(D_800D01DC)
...
/* 4AE4 800142E4 DC018424 */   addiu     $a0, $a0, %lo(D_800D01DC)
...
/* 4B28 80014328 0D80043C */  lui        $a0, %hi(D_800D01F4)
/* 4B2C 8001432C F4018424 */  addiu      $a0, $a0, %lo(D_800D01F4)
...
/* 4B40 80014340 0D80043C */   lui       $a0, %hi(D_800D0210)
.L80014344:
/* 4B44 80014344 0D80043C */  lui        $a0, %hi(D_800D0204)
/* 4B48 80014348 C3B5000C */  jal        FONT_Print
/* 4B4C 8001434C 04028424 */   addiu     $a0, $a0, %lo(D_800D0204)
/* 4B50 80014350 0D80043C */  lui        $a0, %hi(D_800D0210)
.L80014354:
/* 4B54 80014354 2802258E */  lw         $a1, 0x228($s1)
/* 4B58 80014358 C3B5000C */  jal        FONT_Print
/* 4B5C 8001435C 10028424 */   addiu     $a0, $a0, %lo(D_800D0210)
/* 4B60 80014360 0D80043C */  lui        $a0, %hi(D_800D021C)
/* 4B64 80014364 F4AC858F */  lw         $a1, %gp_rel(theCamera + 0x64)($gp)
/* 4B68 80014368 C3B5000C */  jal        FONT_Print
/* 4B6C 8001436C 1C028424 */   addiu     $a0, $a0, %lo(D_800D021C)
/* 4B70 80014370 2800228E */  lw         $v0, 0x28($s1)
/* 4B74 80014374 0D80043C */  lui        $a0, %hi(D_800D022C)
/* 4B78 80014378 46004594 */  lhu        $a1, 0x46($v0)
/* 4B7C 8001437C 44004694 */  lhu        $a2, 0x44($v0)
/* 4B80 80014380 C3B5000C */  jal        FONT_Print
/* 4B84 80014384 2C028424 */   addiu     $a0, $a0, %lo(D_800D022C)
/* 4B88 80014388 0D80043C */  lui        $a0, %hi(D_800D024C)
/* 4B8C 8001438C E2BF8587 */  lh         $a1, %gp_rel(gameTrackerX + 0x21A)($gp)
/* 4B90 80014390 C3B5000C */  jal        FONT_Print
/* 4B94 80014394 4C028424 */   addiu     $a0, $a0, %lo(D_800D024C)
.L80014398:
...
/* 4BA8 800143A8 0D80043C */  lui        $a0, %hi(D_800D0260)
/* 4BAC 800143AC 60028424 */  addiu      $a0, $a0, %lo(D_800D0260)
/* 4BB0 800143B0 21280002 */  addu       $a1, $s0, $zero
/* 4BB4 800143B4 C3B5000C */  jal        FONT_Print
/* 4BB8 800143B8 21304000 */   addu      $a2, $v0, $zero
/* 4BBC 800143BC 0D80043C */  lui        $a0, %hi(D_800D027C)
/* 4BC0 800143C0 7C028424 */  addiu      $a0, $a0, %lo(D_800D027C)
...
/* 4C04 80014404 0D80043C */   lui       $a0, %hi(D_800D028C)
/* 4C08 80014408 FF0F4224 */  addiu      $v0, $v0, 0xFFF
.L8001440C:
/* 4C0C 8001440C 8C028424 */  addiu      $a0, $a0, %lo(D_800D028C)
...
/* 4C40 80014440 0D80043C */  lui        $a0, %hi(D_800D02A4)
/* 4C44 80014444 C3B5000C */  jal        FONT_Print
/* 4C48 80014448 A4028424 */   addiu     $a0, $a0, %lo(D_800D02A4)
.L8001444C:

...
/* 3D8D4 8004D0D4 0D80023C */   lui       $v0, %hi(objectFunc + 0x120)
/* 3D8D8 8004D0D8 3CA4438C */  lw         $v1, %lo(objectFunc + 0x120)($v0)
...
/* 3D8EC 8004D0EC 0D80033C */   lui       $v1, %hi(objectFunc + 0x120)
/* 3D8F0 8004D0F0 3CA46324 */  addiu      $v1, $v1, %lo(objectFunc + 0x120)
...
.L8004D10C:
/* 3D90C 8004D10C 0D80023C */  lui        $v0, %hi(objectFunc + 0x134)
/* 3D910 8004D110 50A4438C */  lw         $v1, %lo(objectFunc + 0x134)($v0)

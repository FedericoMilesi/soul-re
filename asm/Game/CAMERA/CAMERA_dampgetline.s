...
/* 9B60 80019360 5C8E8227 */  addiu      $v0, $gp, %gp_rel(roll_inc + 0x8)
...
/* 9B7C 8001937C 588E8527 */  addiu      $a1, $gp, %gp_rel(roll_inc + 0x4)
/* 9B80 80019380 21300002 */  addu       $a2, $s0, $zero
/* 9B84 80019384 5A8E8727 */  addiu      $a3, $gp, %gp_rel(roll_inc + 0x6)
/* 9B88 80019388 1C00BFAF */  sw         $ra, 0x1C($sp)
/* 9B8C 8001938C 7E5E000C */  jal        CriticalDampAngle
/* 9B90 80019390 1400A2AF */   sw        $v0, 0x14($sp)
/* 9B94 80019394 588E8287 */  lh         $v0, %gp_rel(roll_inc + 0x4)($gp)
/* 9B98 80019398 588E8397 */  lhu        $v1, %gp_rel(roll_inc + 0x4)($gp)
/* 9B9C 8001939C 01084228 */  slti       $v0, $v0, 0x801
/* 9BA0 800193A0 02004014 */  bnez       $v0, .L800193AC
/* 9BA4 800193A4 00F06224 */   addiu     $v0, $v1, -0x1000
/* 9BA8 800193A8 588E82A7 */  sh         $v0, %gp_rel(roll_inc + 0x4)($gp)
.L800193AC:
/* 9BAC 800193AC 588E8287 */  lh         $v0, %gp_rel(roll_inc + 0x4)($gp)
...
.L800193F0:
/* 9BF0 800193F0 588E82A7 */  sh         $v0, %gp_rel(roll_inc + 0x4)($gp)
.L800193F4:
/* 9BF4 800193F4 588E8287 */  lh         $v0, %gp_rel(roll_inc + 0x4)($gp)

...
/* AA3D0 800B9BD0 0D80103C */  lui        $s0, %hi(D_800CC914)
/* AA3D4 800B9BD4 14C91026 */  addiu      $s0, $s0, %lo(D_800CC914)
...
/* AA3EC 800B9BEC 0D80033C */  lui        $v1, %hi(D_800CD9A0)
/* AA3F0 800B9BF0 A0D9638C */  lw         $v1, %lo(D_800CD9A0)($v1)
/* AA3F4 800B9BF4 0D80023C */  lui        $v0, %hi(D_800CD9A4)
/* AA3F8 800B9BF8 A4D9428C */  lw         $v0, %lo(D_800CD9A4)($v0)
...
/* AA410 800B9C10 0D80023C */  lui        $v0, %hi(D_800CD9A8)
/* AA414 800B9C14 A8D9428C */  lw         $v0, %lo(D_800CD9A8)($v0)
...
.L800B9C40:
/* AA440 800B9C40 0D80103C */  lui        $s0, %hi(D_800CC950)
/* AA444 800B9C44 50C91026 */  addiu      $s0, $s0, %lo(D_800CC950)
...
/* AA464 800B9C64 0D80033C */  lui        $v1, %hi(D_800CD99C)
/* AA468 800B9C68 9CD9638C */  lw         $v1, %lo(D_800CD99C)($v1)
/* AA46C 800B9C6C 1408030C */  jal        startIntrDMA
/* AA470 800B9C70 140062AC */   sw        $v0, 0x14($v1)
/* AA474 800B9C74 0D80043C */  lui        $a0, %hi(D_800CD99C)
/* AA478 800B9C78 9CD9848C */  lw         $a0, %lo(D_800CD99C)($a0)

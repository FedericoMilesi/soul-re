...
/* B67C8 800C5FC8 A5FC020C */  jal        EnterCriticalSection
/* B67CC 800C5FCC 4CED22AC */   sw        $v0, %lo(_spu_isCalled)($at)
/* B67D0 800C5FD0 0C80043C */  lui        $a0, %hi(_spu_FiDMA)
/* B67D4 800C5FD4 B41B030C */  jal        _SpuDataCallback
/* B67D8 800C5FD8 64648424 */   addiu     $a0, $a0, %lo(_spu_FiDMA)
...
/* B67EC 800C5FEC D9FC020C */  jal        OpenEvent
...
/* B67FC 800C5FFC D5FC020C */  jal        EnableEvent
/* B6800 800C6000 E4EC24AC */   sw        $a0, %lo(_spu_EVdma)($at)
/* B6804 800C6004 11FC020C */  jal        ExitCriticalSection

...
/* AA4A8 800B9CA8 0D80113C */  lui        $s1, %hi(D_800CC914)
/* AA4AC 800B9CAC 14C93126 */  addiu      $s1, $s1, %lo(D_800CC914)
...
/* AA4D4 800B9CD4 0D80023C */  lui        $v0, %hi(D_800CD9A0)
/* AA4D8 800B9CD8 A0D9428C */  lw         $v0, %lo(D_800CD9A0)($v0)
...
.L800B9CF8:
/* AA4F8 800B9CF8 0D80043C */  lui        $a0, %hi(D_800CD9A0)
/* AA4FC 800B9CFC A0D9848C */  lw         $a0, %lo(D_800CD9A0)($a0)
/* AA500 800B9D00 30002396 */  lhu        $v1, 0x30($s1)
/* AA504 800B9D04 01000224 */  addiu      $v0, $zero, 0x1
/* AA508 800B9D08 020022A6 */  sh         $v0, 0x2($s1)
/* AA50C 800B9D0C 0D80023C */  lui        $v0, %hi(D_800CD9A4)
/* AA510 800B9D10 A4D9428C */  lw         $v0, %lo(D_800CD9A4)($v0)
...
/* AA554 800B9D54 0D80033C */  lui        $v1, %hi(D_800CD9A0)
/* AA558 800B9D58 A0D9638C */  lw         $v1, %lo(D_800CD9A0)($v1)
...
.L800B9D90:
/* AA590 800B9D90 0D80043C */  lui        $a0, %hi(D_800CD9A0)
/* AA594 800B9D94 A0D9848C */  lw         $a0, %lo(D_800CD9A0)($a0)
/* AA598 800B9D98 0D80033C */  lui        $v1, %hi(D_800CC944)
/* AA59C 800B9D9C 44C96394 */  lhu        $v1, %lo(D_800CC944)($v1)
/* AA5A0 800B9DA0 0D80023C */  lui        $v0, %hi(D_800CD9A4)
/* AA5A4 800B9DA4 A4D9428C */  lw         $v0, %lo(D_800CD9A4)($v0)
...
.L800B9DC0:
/* AA5C0 800B9DC0 0D80053C */  lui        $a1, %hi(D_800CD9A0)
/* AA5C4 800B9DC4 A0D9A58C */  lw         $a1, %lo(D_800CD9A0)($a1)
/* AA5C8 800B9DC8 0D80063C */  lui        $a2, %hi(D_800CD9A4)
/* AA5CC 800B9DCC A4D9C68C */  lw         $a2, %lo(D_800CD9A4)($a2)
...
/* AA5E8 800B9DE8 0D80023C */  lui        $v0, %hi(D_800CD9AC)
/* AA5EC 800B9DEC ACD94224 */  addiu      $v0, $v0, %lo(D_800CD9AC)
...
/* AA624 800B9E24 0D80023C */  lui        $v0, %hi(D_800CD9A0)
/* AA628 800B9E28 A0D9428C */  lw         $v0, %lo(D_800CD9A0)($v0)
/* AA62C 800B9E2C 0D80013C */  lui        $at, %hi(D_800CD9AC)
/* AA630 800B9E30 ACD920AC */  sw         $zero, %lo(D_800CD9AC)($at)
/* AA634 800B9E34 91E70208 */  j          .L800B9E44
/* AA638 800B9E38 000040A4 */   sh        $zero, 0x0($v0)
.L800B9E3C:
/* AA63C 800B9E3C 0D80013C */  lui        $at, %hi(D_800CD9AC)
/* AA640 800B9E40 ACD920AC */  sw         $zero, %lo(D_800CD9AC)($at)
.L800B9E44:
/* AA644 800B9E44 0D80013C */  lui        $at, %hi(D_800CC916)
/* AA648 800B9E48 C408030C */  jal        ReturnFromException
/* AA64C 800B9E4C 16C920A4 */   sh        $zero, %lo(D_800CC916)($at)

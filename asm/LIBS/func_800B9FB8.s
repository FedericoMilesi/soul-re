...
/* AA7C0 800B9FC0 0D80103C */  lui        $s0, %hi(D_800CC914)
/* AA7C4 800B9FC4 14C91026 */  addiu      $s0, $s0, %lo(D_800CC914)
...
/* AA7E4 800B9FE4 0D80023C */  lui        $v0, %hi(D_800CD9A4)
/* AA7E8 800B9FE8 A4D9428C */  lw         $v0, %lo(D_800CD9A4)($v0)
/* AA7EC 800B9FEC 0D80043C */  lui        $a0, %hi(D_800CD9A8)
/* AA7F0 800B9FF0 A8D9848C */  lw         $a0, %lo(D_800CD9A8)($a0)
...
/* AA804 800BA004 0D80043C */  lui        $a0, %hi(D_800CD9A0)
/* AA808 800BA008 A0D9848C */  lw         $a0, %lo(D_800CD9A0)($a0)
...
/* AA820 800BA020 0D80043C */  lui        $a0, %hi(D_800CD9A8)
/* AA824 800BA024 A8D9848C */  lw         $a0, %lo(D_800CD9A8)($a0)

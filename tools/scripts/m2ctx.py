...
def import_c_file(in_file, macro, linemarker) -> str:
    cpp_command = ["mips-linux-gnu-cpp", "-P", "-dM", *CPP_FLAGS, in_file]

    if linemarker:
        cpp_command2 = ["mips-linux-gnu-cpp", *CPP_FLAGS, in_file]
    else:
        cpp_command2 = ["mips-linux-gnu-cpp", "-P", *CPP_FLAGS, in_file]
